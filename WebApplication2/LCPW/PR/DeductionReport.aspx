<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeductionReport.aspx.cs" Inherits="WebApplication2.LCPW.PR.DeductionReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" for="usr"> <h4>Select Deduction Type:</h4> </asp:Label>
