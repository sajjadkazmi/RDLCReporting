...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-group">
        ...
        <table>
            <tr>
                <td>
                    <asp:Label ID="Label4" runat="server" for="usr"> <h4> Select Department:</h4> </asp:Label>
            ...
            <tr>
                <td>
                    ...
                    <asp:ListBox ID="ListBox3" runat="server" class="form-control" SelectionMode="Multiple" ClientIDMode="Static"></asp:ListBox>
