...
using WebApplication2.RBAVARI.PR;
...
namespace WebApplication2.LCPW.PR
{
    public partial class PaySlip : System.Web.UI.Page
    {
        ...
        private void showReport()
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "./LCPW/PR/PaySlip.rdlc";
            //parameter
        ...
        private DataTable GetData(string Date,string EmpName)
        {
            ...
            try
            {
                ...
                OracleDataAdapter da = new OracleDataAdapter("select old_Emp_no || '-' || employee_no emp_no,employee_no, Company_Name, employee_name, father_spouse_name, cnic, appointment_date, confirmation_Date, left_date, extension_date, days_Worked, employment_status, department, designation, grade, worklocation, city, regionname, employee_bank, compensation, nvl(allowance, 0) - nvl(deduction, 0) amt,allowance,deduction,net from LCPW.prv_employeesalaryactl where Process_Month = to_date('" + Date + "','mm/dd/rrrr') AND employee_no IN ('" + EmpName+ "')", con);
        ...
        private void BindListbox()
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    OracleCommand comm = new OracleCommand("Select distinct Process_Month from lcpw.prv_employeesalaryactl order by Process_Month DESC", con);
