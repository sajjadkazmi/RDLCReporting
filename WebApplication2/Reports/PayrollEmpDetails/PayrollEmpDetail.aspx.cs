...
namespace WebApplication2.Reports.PayrollEmpDetails
{
    public partial class PayrollEmpDetail : System.Web.UI.Page
    {
        ...
        private void showReport()
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "./Reports/PayrollEmpDetails/Report3.rdlc";
            //parameter
        ...
        private void BindListbox()
        {
            ...
            try
            {
                ...
                if (con.State == ConnectionState.Closed)
                {
                    ...
                    ListBox1.DataBind();
                    //listbox2
                    OracleCommand com = new OracleCommand("select distinct Process_Month from " + Session["schema_name"] + "prv_employeesalaryactl", con);
