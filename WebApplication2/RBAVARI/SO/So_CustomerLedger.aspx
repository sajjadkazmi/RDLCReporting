        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox id="datepicker" class="form-control datePicker" placeholder="Select Date" runat="server"/>
                    </div>
                ...
                <td>
                    ...
                    <asp:TextBox id="datepicker2" class="form-control datePicker" placeholder="Select Date" runat="server"/>
                    </div>
                </td>
