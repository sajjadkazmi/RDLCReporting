...
{
    public partial class GroupInsurance : System.Web.UI.Page
    {
        ...
        private void showReport()
        {
            ...
            string query = "SELECT OLD_EMP_NO,EMPLOYEE_NAME,FATHER_SPOUSE_NAME,CNIC,APPOINTMENT_DATE,DESIGNATION,DEPARTMENT_CODE,DEPARTMENT_SEQUENCE,DEPARTMENT,LEFT_DATE,ACTIVE_CHECK,BIRTH_DATE,SKILL_LEVEL FROM  lcpw.prv_EMPLOYEEMASTER where ACTIVE_CHECK IN  ('" + Status + "') ";
            string Empty = "";
            //Reset
            ReportViewer1.Reset();
            GlobalReport GLRpt = new GlobalReport();
            ...
            ReportViewer1.LocalReport.ReportPath = "./RBAVARI/PR/GroupInsurance.rdlc";
