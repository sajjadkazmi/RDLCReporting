<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FnF.aspx.cs" Inherits="WebApplication2.RBAVARI.PR.FnF" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" for="usr"> <h4>Select Emlpoyee Name:</h4> </asp:Label>
