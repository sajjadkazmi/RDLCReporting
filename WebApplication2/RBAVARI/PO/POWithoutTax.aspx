<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="POWithoutTax.aspx.cs" Inherits="WebApplication2.RBAVARI.PO.POWithoutTax" %>
     ...
     <div class="form-group">
        <table>
            <tr>
                ...
                <td>
                    <asp:Label ID="Label2" runat="server" for="usr"> <h4>Select Purchase Order No:</h4> </asp:Label>
                    <asp:Button ID="Button1" class="btn btn-primary" runat="server" OnClick="Button2_Click" Text="Select"></asp:Button>
                    <asp:ListBox ID="ListBox1" runat="server" class="form-control" SelectionMode="Single" ClientIDMode="Static"></asp:ListBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" for="usr"> <h4>Select Status :</h4> </asp:Label>
